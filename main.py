...
class Elochka:
    sessionKey = 'ba2e28ec65a35b2c8824562cfd9854b7cb8b9a94'
    ...
    def factoryExchange(self):
        sign = 'e16b1c675a77b5c7d44c3cb841b2d416'
        ...
        data = '{"params":{"name":"farm1"},"uid":125744,"suid":"225299625","aid":"7113532","authKey":"de7afe2878276a4091b89bd70ee1d9d1","sessionKey":"' + self.sessionKey + '","version":18,"clientPlatform":"js","sign":"' + sign + '"}'
        # print(data)
        r = requests.post(url, data=data, headers=headers)
        r = r.json()
    ...
    def openChest(self):
        sign = 'f51aee17d8f95db54592f61cbd6e0c52'
        ...
        data = '{"params":{"chestId":2},"uid":125744,"suid":"225299625","aid":"7113532","authKey":"de7afe2878276a4091b89bd70ee1d9d1","sessionKey":"' + self.sessionKey + '","version":18,"clientPlatform":"js","sign":"' +  sign + '"}'
